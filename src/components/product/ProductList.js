      ...
      <div className='filter-control'>
        ...
        <div className="filter-div filter-spec">
          <label htmlFor="size">Price:</label>
              <input type="number" id="minPrice" placeholder="min. idr" name="minPrice" value={minPrice} onChange={(event) => setMinPrice(event.target.value)} />
              <p>-</p>
              <input type="number" id="maxPrice" placeholder="max. idr" name="maxPrice" value={maxPrice} onChange={(event) => setMaxPrice(event.target.value)} />
        </div>
        <div className="filter-div">
          <label>Sort by:</label>
